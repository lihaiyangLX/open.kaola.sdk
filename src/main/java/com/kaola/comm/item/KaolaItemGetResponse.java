...
import com.kaola.item.ItemCategory;
import com.kaola.item.ItemImage;
import com.kaola.item.ItemPostage;
import com.kaola.item.ItemProperty;
import com.kaola.item.ItemTextProperty;
import com.kaola.item.RawItemEdit;
import com.kaola.item.Sku;
 ...
 * 2018年3月16日
 */
public class KaolaItemGetResponse {

	private RawItemEdit raw_item_edit; // 商品的基本信息

	private String key; // 商品的key

	private List<ItemCategory> item_category_list; // 商品类目信息

	private List<ItemProperty> item_property_list; // 商品预定义属性

	private List<ItemTextProperty> item_text_property_list; // 商品自定义属性

	private List<Sku> sku_list; // 商品包含的SKU

	private List<ItemImage> item_image_list; // 商品图片
